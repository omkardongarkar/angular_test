...
@Component({
  selector: 'app-geography-dashboard',
  templateUrl: './user-geo.component.html',
  styleUrls: ['./user-geo.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule, 
...
export class UserGeographyComponent implements OnInit {
